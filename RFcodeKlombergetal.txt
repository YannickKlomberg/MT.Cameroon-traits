...
write.xlsx(round(importance(RF.PriPoll),2), file = "Imp_PriPoll.xlsx")
...
##results RF
write.xlsx(round(importance(RF.SecPoll),2), file = "Imp_SecPoll.xlsx")
...
MSDRY4 %<>% mutate_at(cols, funs(factor(.)))
MSDRY4$Shape <- factor(MSDRY4$Shape, levels = levels(PriPoll3$Shape))
MSDRY4$Colour <- factor(MSDRY4$Colour , levels = levels(PriPoll3$Colour))
MSDRY4$FL_Position <- factor(MSDRY4$FL_Position  , levels = levels(PriPoll3$FL_Position))
MSDRY4$Od_Strength <- factor(MSDRY4$Od_Strength  , levels = levels(PriPoll3$Od_Strength))
MSDRYPrediction <- predict(RF.PriPoll, MSDRY4, type="response")

#prediction MSWET
MSWET4 <- MSWET3[c(2:11)]
row.names(MSWET4) <- MSWET$SpCode
MSWET4 %<>% mutate_at(cols, funs(factor(.)))
MSWET4$Shape <- factor(MSWET4$Shape, levels = levels(PriPoll3$Shape))
MSWET4$Colour <- factor(MSWET4$Colour , levels = levels(PriPoll3$Colour))
MSWET4$FL_Position <- factor(MSWET4$FL_Position  , levels = levels(PriPoll3$FL_Position))
MSWET4$Od_Strength <- factor(MSWET4$Od_Strength  , levels = levels(PriPoll3$Od_Strength))
MSWETPrediction <- predict(RF.PriPoll, MSWET4, type="response")

#prediction CLDRY
CLDRY4 <- CLDRY3[c(2:11)]
row.names(CLDRY4) <- CLDRY$SpCode
CLDRY4 %<>% mutate_at(cols, funs(factor(.)))
CLDRY4$Shape <- factor(CLDRY4$Shape, levels = levels(PriPoll3$Shape))
CLDRY4$Colour <- factor(CLDRY4$Colour , levels = levels(PriPoll3$Colour))
CLDRY4$FL_Position <- factor(CLDRY4$FL_Position  , levels = levels(PriPoll3$FL_Position))
CLDRY4$Od_Strength <- factor(CLDRY4$Od_Strength  , levels = levels(PriPoll3$Od_Strength))
CLDRYPrediction <- predict(RF.PriPoll, CLDRY4, type="response")

#prediction CLWET
CLWET4 <- CLWET3[c(2:11)]
row.names(CLWET4) <- CLWET$SpCode
CLWET4 %<>% mutate_at(cols, funs(factor(.)))
CLWET4$Shape <- factor(CLWET4$Shape, levels = levels(PriPoll3$Shape))
CLWET4$Colour <- factor(CLWET4$Colour , levels = levels(PriPoll3$Colour))
CLWET4$FL_Position <- factor(CLWET4$FL_Position  , levels = levels(PriPoll3$FL_Position))
CLWET4$Od_Strength <- factor(CLWET4$Od_Strength  , levels = levels(PriPoll3$Od_Strength))
CLWETPrediction <- predict(RF.PriPoll, CLWET4, type="response")

#prediction PCDRY
PCDRY4 <- PCDRY3[c(2:11)]
row.names(PCDRY4) <- PCDRY$SpCode
PCDRY4 %<>% mutate_at(cols, funs(factor(.)))
PCDRY4$Shape <- factor(PCDRY4$Shape, levels = levels(PriPoll3$Shape))
PCDRY4$Colour <- factor(PCDRY4$Colour , levels = levels(PriPoll3$Colour))
PCDRY4$FL_Position <- factor(PCDRY4$FL_Position  , levels = levels(PriPoll3$FL_Position))
PCDRY4$Od_Strength <- factor(PCDRY4$Od_Strength  , levels = levels(PriPoll3$Od_Strength))
PCDRYPrediction <- predict(RF.PriPoll, PCDRY4, type="response")

#prediction PCWET
PCWET4 <- PCWET3[c(2:11)]
row.names(PCWET4) <- PCWET$SpCode
PCWET4 %<>% mutate_at(cols, funs(factor(.)))
PCWET4$Shape <- factor(PCWET4$Shape, levels = levels(PriPoll3$Shape))
PCWET4$Colour <- factor(PCWET4$Colour , levels = levels(PriPoll3$Colour))
PCWET4$FL_Position <- factor(PCWET4$FL_Position  , levels = levels(PriPoll3$FL_Position))
PCWET4$Od_Strength <- factor(PCWET4$Od_Strength  , levels = levels(PriPoll3$Od_Strength))
PCWETPrediction <- predict(RF.PriPoll, PCWET4, type="response")

#prediction DGDRY
DGDRY4 <- DGDRY3[c(2:11)]
row.names(DGDRY4) <- DGDRY$SpCode
DGDRY4 %<>% mutate_at(cols, funs(factor(.)))
DGDRY4$Shape <- factor(DGDRY4$Shape, levels = levels(PriPoll3$Shape))
DGDRY4$Colour <- factor(DGDRY4$Colour , levels = levels(PriPoll3$Colour))
DGDRY4$FL_Position <- factor(DGDRY4$FL_Position  , levels = levels(PriPoll3$FL_Position))
DGDRY4$Od_Strength <- factor(DGDRY4$Od_Strength  , levels = levels(PriPoll3$Od_Strength))
DGDRYPrediction <- predict(RF.PriPoll, DGDRY4, type="response")

#prediction DGWET
DGWET4 <- DGWET3[c(2:11)]
row.names(DGWET4) <- DGWET$SpCode
DGWET4 %<>% mutate_at(cols, funs(factor(.)))
DGWET4$Shape <- factor(DGWET4$Shape, levels = levels(PriPoll3$Shape))
DGWET4$Colour <- factor(DGWET4$Colour , levels = levels(PriPoll3$Colour))
DGWET4$FL_Position <- factor(DGWET4$FL_Position  , levels = levels(PriPoll3$FL_Position))
DGWET4$Od_Strength <- factor(DGWET4$Od_Strength  , levels = levels(PriPoll3$Od_Strength))
...
row.names(MSDRY4) <- MSDRY$SpCode
MSDRY4 %<>% mutate_at(cols, funs(factor(.)))
MSDRY4$Shape <- factor(MSDRY4$Shape, levels = levels(SecPoll3$Shape))
MSDRY4$Colour <- factor(MSDRY4$Colour , levels = levels(SecPoll3$Colour))
MSDRY4$FL_Position <- factor(MSDRY4$FL_Position  , levels = levels(SecPoll3$FL_Position))
MSDRY4$Od_Strength <- factor(MSDRY4$Od_Strength  , levels = levels(SecPoll3$Od_Strength))
...
row.names(MSWET4) <- MSWET$SpCode
MSWET4 %<>% mutate_at(cols, funs(factor(.)))
MSWET4$Shape <- factor(MSWET4$Shape, levels = levels(SecPoll3$Shape))
MSWET4$Colour <- factor(MSWET4$Colour , levels = levels(SecPoll3$Colour))
MSWET4$FL_Position <- factor(MSWET4$FL_Position  , levels = levels(SecPoll3$FL_Position))
MSWET4$Od_Strength <- factor(MSWET4$Od_Strength  , levels = levels(SecPoll3$Od_Strength))
...
row.names(CLDRY4) <- CLDRY$SpCode
CLDRY4 %<>% mutate_at(cols, funs(factor(.)))
CLDRY4$Shape <- factor(CLDRY4$Shape, levels = levels(SecPoll3$Shape))
CLDRY4$Colour <- factor(CLDRY4$Colour , levels = levels(SecPoll3$Colour))
CLDRY4$FL_Position <- factor(CLDRY4$FL_Position  , levels = levels(SecPoll3$FL_Position))
CLDRY4$Od_Strength <- factor(CLDRY4$Od_Strength  , levels = levels(SecPoll3$Od_Strength))
...
row.names(CLWET4) <- CLWET$SpCode
CLWET4 %<>% mutate_at(cols, funs(factor(.)))
CLWET4$Shape <- factor(CLWET4$Shape, levels = levels(SecPoll3$Shape))
CLWET4$Colour <- factor(CLWET4$Colour , levels = levels(SecPoll3$Colour))
CLWET4$FL_Position <- factor(CLWET4$FL_Position  , levels = levels(SecPoll3$FL_Position))
CLWET4$Od_Strength <- factor(CLWET4$Od_Strength  , levels = levels(SecPoll3$Od_Strength))
...
row.names(PCDRY4) <- PCDRY$SpCode
PCDRY4 %<>% mutate_at(cols, funs(factor(.)))
PCDRY4$Shape <- factor(PCDRY4$Shape, levels = levels(SecPoll3$Shape))
PCDRY4$Colour <- factor(PCDRY4$Colour , levels = levels(SecPoll3$Colour))
PCDRY4$FL_Position <- factor(PCDRY4$FL_Position  , levels = levels(SecPoll3$FL_Position))
PCDRY4$Od_Strength <- factor(PCDRY4$Od_Strength  , levels = levels(SecPoll3$Od_Strength))
...
row.names(PCWET4) <- PCWET$SpCode
PCWET4 %<>% mutate_at(cols, funs(factor(.)))
PCWET4$Shape <- factor(PCWET4$Shape, levels = levels(SecPoll3$Shape))
PCWET4$Colour <- factor(PCWET4$Colour , levels = levels(SecPoll3$Colour))
PCWET4$FL_Position <- factor(PCWET4$FL_Position  , levels = levels(SecPoll3$FL_Position))
PCWET4$Od_Strength <- factor(PCWET4$Od_Strength  , levels = levels(SecPoll3$Od_Strength))
...
row.names(DGDRY4) <- DGDRY$SpCode
DGDRY4 %<>% mutate_at(cols, funs(factor(.)))
DGDRY4$Shape <- factor(DGDRY4$Shape, levels = levels(SecPoll3$Shape))
DGDRY4$Colour <- factor(DGDRY4$Colour , levels = levels(SecPoll3$Colour))
DGDRY4$FL_Position <- factor(DGDRY4$FL_Position  , levels = levels(SecPoll3$FL_Position))
DGDRY4$Od_Strength <- factor(DGDRY4$Od_Strength  , levels = levels(SecPoll3$Od_Strength))
...
row.names(DGWET4) <- DGWET$SpCode
DGWET4 %<>% mutate_at(cols, funs(factor(.)))
DGWET4$Shape <- factor(DGWET4$Shape, levels = levels(SecPoll3$Shape))
DGWET4$Colour <- factor(DGWET4$Colour , levels = levels(SecPoll3$Colour))
DGWET4$FL_Position <- factor(DGWET4$FL_Position  , levels = levels(SecPoll3$FL_Position))
DGWET4$Od_Strength <- factor(DGWET4$Od_Strength  , levels = levels(SecPoll3$Od_Strength))
DGWET4$Ant_Position <- factor(DGWET4$Ant_Position  , levels = levels(SecPoll3$Ant_Position))
